                            ...
                            <div class="swiper-wrapper">
                                @foreach ($npackages as $npackage)
                                    <div class="swiper-slide">
                                        ...
                                        @auth
                                            <a href="{{ route('joinmin_user.create') }}" class="btn btn-danger">Join</a>
                                        @else
                                            <a href="{{ route('login') }}" class="btn btn-danger">Join</a>
                                        @endauth
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="swiper-wrapper">
                                @foreach ($packages as $package)
                                    <div class="swiper-slide">
                                        ...
                                        @auth
                                            <a href="{{ route('joinplus_user.create') }}" class="btn btn-danger">Join</a>
                                        @else
                                            <a href="{{ route('login') }}" class="btn btn-danger">Join</a>
                                        @endauth
                                        </div>
