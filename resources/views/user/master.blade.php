...
-->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('userlte')}}/assets/css/bootstrap.min.css">

    <link rel="stylesheet" type="text/css" href="{{asset('userlte')}}/assets/css/font-awesome.css">

    <link rel="stylesheet" href="{{asset('userlte')}}/assets/css/templatemo-training-studio.css">
    ...
    <!-- jQuery -->
    <script src="{{asset('userlte')}}/assets/js/jquery-2.1.0.min.js"></script>

    <!-- Bootstrap -->
    <script src="{{asset('userlte')}}/assets/js/popper.js"></script>
    <script src="{{asset('userlte')}}/assets/js/bootstrap.min.js"></script>

    <!-- Plugins -->
    <script src="{{asset('userlte')}}/assets/js/scrollreveal.min.js"></script>
    <script src="{{asset('userlte')}}/assets/js/waypoints.min.js"></script>
    <script src="{{asset('userlte')}}/assets/js/jquery.counterup.min.js"></script>
    <script src="{{asset('userlte')}}/assets/js/imgfix.min.js"></script> 
    <script src="{{asset('userlte')}}/assets/js/mixitup.js"></script> 
    <script src="{{asset('userlte')}}/assets/js/accordions.js"></script>
    
    <!-- Global Init -->
    <script src="{{asset('userlte')}}/assets/js/custom.js"></script>
