  ...
  {{-- <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">Gym</h1><span>.</span>
      </a>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="content px-xl-5">
              <h3><span>Sering ditanyakan </span><strong>Questions</strong></h3>
            </div>
          </div>
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="faq-container">
              <div class="faq-item faq-active">
                <h3><span class="num">1.</span> <span>Bagaimana menaikkan berat badan?</span></h3>
                <div class="faq-content">
                  <p>Lakukan bulking dengan mengangkat beban....</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3><span class="num">2.</span> <span>Bagaimana menurunkan berat badan?</span></h3>
                <div class="faq-content">
                  <p>Lakukan cardio dengan lari...</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3><span class="num">3.</span> <span>Bagaimana dengan asupan makan supaya seimbang?</span></h3>
                <div class="faq-content">Pilih menu makan dengan protein seimbang sesuaikan dengan kebutuhan dan 4 sehat 5 sempurna</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3><span class="num">4.</span> <span>Berapa waktu yang dibutuhkan supaya badan ideal?</span></h3>
                <div class="faq-content">
                  <p>Waktu agar badan terlihat dilihat dari olahraga konsisten dan asupan yang seimbang.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3><span class="num">5.</span> <span>Berapa lama waktu dalam sehari yang dibutuhkan saat olahraga ?</span></h3>
                <div class="faq-content">
                  <p>Dalam sehari 1-2 jam</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
